 ...
 * @LastEditTime: 2022-03-05 21:56:54
...
LFP_STATIC LFP_CODE LFP_INT32 (*lfp_adapter_register[])(LFP_VOID) = {
    lfp_arch_adapter_pthread_register,   lfp_arch_adapter_mutex_register,
    lfp_arch_adapter_semaphore_register, lfp_arch_adapter_fileio_register,
    lfp_arch_adapter_stdio_register,     lfp_arch_adapter_socket_register,
