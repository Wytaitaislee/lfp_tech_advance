...
LFP_ARCH_ADAPTER5(LFP_GET_PTHREAD_ENTRY(), pthread_create, LFP_INT32, LFP_PTHREAD_HADLE_T*, LFP_INT32, LFP_UINT32, LFP_VOID*, LFP_VOID*);
LFP_ARCH_ADAPTER1(LFP_GET_PTHREAD_ENTRY(), pthread_cancel, LFP_INT32, LFP_PTHREAD_HADLE_T);
LFP_ARCH_ADAPTER2(LFP_GET_PTHREAD_ENTRY(), pthread_kill, LFP_INT32, LFP_PTHREAD_HADLE_T, LFP_INT32);
