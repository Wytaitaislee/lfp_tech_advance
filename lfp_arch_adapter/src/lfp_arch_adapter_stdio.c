/*
 * @FilePath: lfp_arch_adapter_stdio.c
 * @Description: System adaptation layer. Adapter to different stdio on
 * different OS..
 * @Author: wytaitaislee
...
LFP_ARCH_ADAPTER2(LFP_GET_STDIO_ENTRY(), stdio_open, LFP_FILE *,
                  LFP_CONST LFP_INT8 *LFP_RESTRICT,
                  LFP_CONST LFP_INT8 *LFP_RESTRICT);
LFP_ARCH_ADAPTER3(LFP_GET_STDIO_ENTRY(), stdio_seek, LFP_INT32, LFP_FILE *,
                  LFP_LONG, LFP_INT32);
LFP_ARCH_ADAPTER4(LFP_GET_STDIO_ENTRY(), stdio_read, LFP_SIZE_T,
                  LFP_VOID *LFP_RESTRICT, LFP_SIZE_T, LFP_SIZE_T,
                  LFP_FILE *LFP_RESTRICT);
LFP_ARCH_ADAPTER4(LFP_GET_STDIO_ENTRY(), stdio_write, LFP_SIZE_T,
                  LFP_CONST LFP_VOID *LFP_RESTRICT, LFP_SIZE_T, LFP_SIZE_T,
                  LFP_FILE *LFP_RESTRICT);
