...
* @return	  LFP_OK / LFP_ERR
*/
LFP_INT32 linux_socket_bind(LFP_INT32 iSocket, LFP_CONST LFP_SOCK_ADDR_T *pStruAddr, LFP_SOCKLEN_T iSockLen)
{
	LFP_INT32 iRet = 0;
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_INT32 linux_socket_accept(LFP_INT32 iSocket, LFP_SOCK_ADDR_T *pStruAddr, LFP_SOCKLEN_T* pSockLen)
{
	LFP_ASSERT_ERR_RET(iSocket > 0);
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_INT32 linux_socket_connect(LFP_INT32 iSocket, const LFP_SOCK_ADDR_T *pStruAddr, LFP_SOCKLEN_T iSockLen)
{
	LFP_INT32 iRet = 0;
...
/*@fn		  LFP_SSIZE_T linux_socket_write(LFP_INT32 iSocket, const LFP_VOID* pBuf, LFP_SIZE_T iLen)
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T linux_socket_write(LFP_INT32 iSocket, LFP_CONST LFP_VOID* pBuf, LFP_SIZE_T iLen)
{
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T linux_socket_send(LFP_INT32 iSocket, LFP_CONST LFP_VOID* pBuf, LFP_SIZE_T iLen, LFP_INT32 iFlags)
{
	LFP_SSIZE_T iSendBytes = 0;
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T linux_socket_sendto(LFP_INT32 iSocket, LFP_CONST LFP_VOID* pBuf, LFP_SIZE_T iLen, LFP_INT32 iFlags, LFP_CONST LFP_SOCK_ADDR_T *pDstAddr, LFP_SOCKLEN_T iSockLen)
{
	LFP_SSIZE_T iSendBytes = 0;
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T linux_socket_sendmsg(LFP_INT32 iSocket, LFP_CONST LFP_MSGHDR_T *pMsg, LFP_INT32 iFlags)
{
	LFP_SSIZE_T iSendBytes = 0;
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T linux_socket_read(LFP_INT32 iSocket, LFP_VOID* pBuf, LFP_SIZE_T iLen)
{
	LFP_ASSERT_ERR_RET((iSocket > 0) && (iLen > 0));
	LFP_ASSERT_ERR_RET(pBuf);
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T linux_socket_recv(LFP_INT32 iSocket, LFP_VOID* pBuf, LFP_SIZE_T iLen, LFP_INT32 iFlags)
{
	LFP_ASSERT_ERR_RET((iSocket > 0) && (iLen > 0));
	LFP_ASSERT_ERR_RET(pBuf);
...
/*@fn		  LFP_SSIZE_T linux_socket_recvfrom(LFP_INT32 iSocket, LFP_VOID* pBuf, LFP_SIZE_T iLen, LFP_INT32 iFlags, 
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T linux_socket_recvfrom(LFP_INT32 iSocket, LFP_VOID* pBuf, LFP_SIZE_T iLen, LFP_INT32 iFlags, LFP_SOCK_ADDR_T *pSrcAddr, LFP_SOCKLEN_T *pSockLen)
{
	LFP_ASSERT_ERR_RET((iSocket > 0) && (iLen > 0));
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T linux_socket_recvmsg(LFP_INT32 iSocket, LFP_MSGHDR_T *pMsg, LFP_INT32 iFlags)
{
	LFP_ASSERT_ERR_RET(iSocket > 0);
	LFP_ASSERT_ERR_RET(pMsg);
