...
#define LFP_MUTEX_CRIT(...) \
    LFP_LOG_BASE(LOG_LEVEL_CRIT, LOG_MODULE_LINUX, MASK_MUTEX, __VA_ARGS__)
#define LFP_MUTEX_ERR(...) \
    LFP_LOG_BASE(LOG_LEVEL_ERR, LOG_MODULE_LINUX, MASK_MUTEX, __VA_ARGS__)
#define LFP_MUTEX_INFO(...) \
    LFP_LOG_BASE(LOG_LEVEL_INFO, LOG_MODULE_LINUX, MASK_MUTEX, __VA_ARGS__)
