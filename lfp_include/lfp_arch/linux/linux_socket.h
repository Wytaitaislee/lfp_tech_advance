...
#define LFP_LINUX_SOCKET_CRIT(...) \
  LFP_LOG_BASE(LOG_LEVEL_CRIT, LOG_MODULE_LINUX, MASK_SOCKET, __VA_ARGS__)
#define LFP_LINUX_SOCKET_ERR(...) \
  LFP_LOG_BASE(LOG_LEVEL_ERR, LOG_MODULE_LINUX, MASK_SOCKET, __VA_ARGS__)
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_INT32 linux_socket_bind(LFP_INT32 iSocketFd,
 ...
 * LINUX_SOCK_ADDR_T *pStruAddr, LINUX_SOCKLEN_T* pSockLen)
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_INT32 linux_socket_accept(LFP_INT32 iSockFd, LINUX_SOCK_ADDR_T *pStruAddr,
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_INT32 linux_socket_connect(LFP_INT32 iSocketFd,
                               const LINUX_SOCK_ADDR_T *pStruAddr,
                               LINUX_SOCKLEN_T iSockLen);
...
/*@fn		  LINUX_SSIZE_T linux_socket_write(LFP_INT32 iSocket, LFP_CONST
 * LFP_VOID* pBuf, LINUX_SIZE_T iLen)
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LINUX_SSIZE_T linux_socket_write(LFP_INT32 iSocketFd, LFP_CONST LFP_VOID *pBuf,
                                 LINUX_SIZE_T iLen);
 ...
 * LFP_VOID* pBuf, LINUX_SIZE_T iLen, LFP_INT32 iFlags)
 * @brief 	  send data to the socket
 * @param[in]  LFP_INT32 iSocket - The specified socket
 * @param[in]  LFP_CONST LFP_VOID* pBuf - the data to be sent
 * @param[in]  LINUX_SIZE_T iLen - the length of the data
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LINUX_SSIZE_T linux_socket_send(LFP_INT32 iSocketFd, LFP_CONST LFP_VOID *pBuf,
                                LINUX_SIZE_T iLen, LFP_INT32 iFlags);

/*@fn		  linux_socket_sendto(LFP_INT32 iSocket, LFP_CONST LFP_VOID*
pBuf, LINUX_SIZE_T iLen, LFP_INT32 iFlags, LFP_CONST LINUX_SOCK_ADDR_T
*pDstAddr, LINUX_SOCKLEN_T iSockLen)
* @brief 	  send data to the socket
* @param[in]  LFP_INT32 iSocket - The specified socket
* @param[in]  LFP_CONST LFP_VOID* pBuf - the data to be sent
* @param[in]  LINUX_SIZE_T iLen - the length of the data
...
* @return	  LFP_OK / LFP_ERR
*/
LINUX_SSIZE_T linux_socket_sendto(LFP_INT32 iSockFd, const LFP_VOID *pBuf,
                                  LINUX_SIZE_T iLen, LFP_INT32 iFlags,
                                  const LINUX_SOCK_ADDR_T *pDstAddr,
                                  LINUX_SOCKLEN_T iSockLen);

/*@fn		  LINUX_SSIZE_T linux_socket_sendmsg(LFP_INT32 iSocket,
 * LFP_CONST LINUX_MSGHDR_T *pMsg, LFP_INT32 iFlags)
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LINUX_SSIZE_T linux_socket_sendmsg(LFP_INT32 iSocketFd,
                                   const LINUX_MSGHDR_T *pMsg,
                                   LFP_INT32 iFlags);

/*@fn		  LINUX_SSIZE_T linux_socket_read(LFP_INT32 iSocket, LFP_VOID*
 * pBuf, LINUX_SIZE_T iLen)
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LINUX_SSIZE_T linux_socket_read(LFP_INT32 iSockFd, LFP_VOID *pBuf,
                                LINUX_SIZE_T iLen);

/*@fn		  LINUX_SSIZE_T linux_socket_recv(LFP_INT32 iSocket, LFP_VOID*
 * pBuf, LINUX_SIZE_T iLen, LFP_INT32 iFlags)
 * @brief 	  recv data from a specified socket.
 * @param[in]  LFP_INT32 iSocket - The specified socket
 * @param[in]  LFP_CONST LFP_VOID* pBuf - the data to be recv
 * @param[in]  LINUX_SIZE_T iLen - the length of the data
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LINUX_SSIZE_T linux_socket_recv(LFP_INT32 iSockFd, LFP_VOID *pBuf,
                                LINUX_SIZE_T iLen, LFP_INT32 iFlags);

/*@fn		  LINUX_SSIZE_T linux_socket_recvfrom(LFP_INT32 iSockFd,
LFP_VOID* pBuf, LINUX_SIZE_T iLen, LFP_INT32 iFlags, LINUX_SOCK_ADDR_T
*pSrcAddr, LINUX_SOCKLEN_T *pSockLen)
...
* @return	  LFP_OK / LFP_ERR
*/
LINUX_SSIZE_T linux_socket_recvfrom(LFP_INT32 iSockFd, LFP_VOID *pBuf,
                                    LINUX_SIZE_T iLen, LFP_INT32 iFlags,
                                    LINUX_SOCK_ADDR_T *pSrcAddr,
                                    LINUX_SOCKLEN_T *pSockLen);

/*@fn		  LINUX_SSIZE_T linux_socket_recvmsg(LFP_INT32 iSocket,
 * LINUX_MSGHDR_T *pMsg, LFP_INT32 iFlags)
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LINUX_SSIZE_T linux_socket_recvmsg(LFP_INT32 iSocketFd, LINUX_MSGHDR_T *pMsg,
                                   LFP_INT32 iFlags);
