/***
 * @FilePath: lfp_arch_adapter_typesdef.h
 * @Description: Private data structure of platform adaptation layer. the file
 * only can be invoked by lfp_arch_xxxx.c.
 * @Author: wytaitaislee
 * @Date: 2021-08-27 23:29:52
 * @LastEditTime: 2022-03-05 21:59:10
...
#define LFP_ARCH_ADAPTER_UNDEF(LFP_ADAPTER_RETURN, LFP_CLASS,                 \
                               LFP_ADAPTER_FUNCTION_NAME)                     \
    do {                                                                      \
...
#define LFP_ARCH_ADAPTER0(LFP_ADAPTER_CLASS, LFP_ADAPTER_FUNCTION_NAME, \
                          LFP_ADAPTER_RETURN)                           \
    LFP_ADAPTER_RETURN lfp_##LFP_ADAPTER_FUNCTION_NAME() {              \
        if (NULL != LFP_ADAPTER_CLASS.LFP_ADAPTER_FUNCTION_NAME) {      \
            ...
            LFP_ARCH_ADAPTER_UNDEF(LFP_ADAPTER_RETURN, LFP_CLASS,       \
                                   LFP_ADAPTER_FUNCTION_NAME);          \
        }                                                               \
    }

/* General structure definition, 1 parameters. */
#define LFP_ARCH_ADAPTER1(LFP_ADAPTER_CLASS, LFP_ADAPTER_FUNCTION_NAME, \
                          LFP_ADAPTER_RETURN, LFP_ADAPTER_PARAM_TYPE1)  \
    LFP_ADAPTER_RETURN lfp_##LFP_ADAPTER_FUNCTION_NAME(                 \
        LFP_ADAPTER_PARAM_TYPE1 value) {                                \
        if (NULL != LFP_ADAPTER_CLASS.LFP_ADAPTER_FUNCTION_NAME) {      \
...
#define LFP_ARCH_ADAPTER2(LFP_ADAPTER_CLASS, LFP_ADAPTER_FUNCTION_NAME,         \
                          LFP_ADAPTER_RETURN, LFP_ADAPTER_PARAM_TYPE1,          \
                          LFP_ADAPTER_PARAM_TYPE2)                              \
    LFP_ADAPTER_RETURN lfp_##LFP_ADAPTER_FUNCTION_NAME(                         \
        LFP_ADAPTER_PARAM_TYPE1 value1, LFP_ADAPTER_PARAM_TYPE2 value2) {       \
        if (NULL != LFP_ADAPTER_CLASS.LFP_ADAPTER_FUNCTION_NAME) {              \
...
#define LFP_ARCH_ADAPTER3(LFP_ADAPTER_CLASS, LFP_ADAPTER_FUNCTION_NAME,        \
                          LFP_ADAPTER_RETURN, LFP_ADAPTER_PARAM_TYPE1,         \
                          LFP_ADAPTER_PARAM_TYPE2, LFP_ADAPTER_PARAM_TYPE3)    \
    LFP_ADAPTER_RETURN lfp_##LFP_ADAPTER_FUNCTION_NAME(                        \
        LFP_ADAPTER_PARAM_TYPE1 value1, LFP_ADAPTER_PARAM_TYPE2 value2,        \
...
#define LFP_ARCH_ADAPTER4(LFP_ADAPTER_CLASS, LFP_ADAPTER_FUNCTION_NAME,         \
                          LFP_ADAPTER_RETURN, LFP_ADAPTER_PARAM_TYPE1,          \
                          LFP_ADAPTER_PARAM_TYPE2, LFP_ADAPTER_PARAM_TYPE3,     \
                          LFP_ADAPTER_PARAM_TYPE4)                              \
    LFP_ADAPTER_RETURN lfp_##LFP_ADAPTER_FUNCTION_NAME(                         \
        LFP_ADAPTER_PARAM_TYPE1 value1, LFP_ADAPTER_PARAM_TYPE2 value2,         \
        LFP_ADAPTER_PARAM_TYPE3 value3, LFP_ADAPTER_PARAM_TYPE4 value4) {       \
        if (NULL != LFP_ADAPTER_CLASS.LFP_ADAPTER_FUNCTION_NAME) {              \
            return LFP_ADAPTER_CLASS.LFP_ADAPTER_FUNCTION_NAME(value1, value2,  \
                                                               value3, value4); \
        } else {                                                                \
...
#define LFP_ARCH_ADAPTER5(LFP_ADAPTER_CLASS, LFP_ADAPTER_FUNCTION_NAME,     \
                          LFP_ADAPTER_RETURN, LFP_ADAPTER_PARAM_TYPE1,      \
                          LFP_ADAPTER_PARAM_TYPE2, LFP_ADAPTER_PARAM_TYPE3, \
...
#define LFP_ARCH_ADAPTER6(                                                     \
    LFP_ADAPTER_CLASS, LFP_ADAPTER_FUNCTION_NAME, LFP_ADAPTER_RETURN,          \
    ...
    LFP_ADAPTER_RETURN lfp_##LFP_ADAPTER_FUNCTION_NAME(                        \
        LFP_ADAPTER_PARAM_TYPE1 value1, LFP_ADAPTER_PARAM_TYPE2 value2,        \
        LFP_ADAPTER_PARAM_TYPE3 value3, LFP_ADAPTER_PARAM_TYPE4 value4,        \
        LFP_ADAPTER_PARAM_TYPE5 value5, LFP_ADAPTER_PARAM_TYPE6 value6) {      \
        if (NULL != LFP_ADAPTER_CLASS.LFP_ADAPTER_FUNCTION_NAME) {             \
            return LFP_ADAPTER_CLASS.LFP_ADAPTER_FUNCTION_NAME(                \
