...
typedef struct lfp_arch_adapter_pthread_t {
    /* data */
    LFP_INT32(*pthread_create)
    (LFP_PTHREAD_HANDLE_T *pThreadHandle, LFP_INT32 iPrority,
     LFP_UINT32 uiStackSize, LFP_VOID *pStartTask, LFP_VOID *pParams);
    LFP_INT32(*pthread_cancel)
    (LFP_PTHREAD_HANDLE_T hThreadHandle);
    LFP_INT32(*pthread_kill)
    (LFP_PTHREAD_HANDLE_T hThreadHandle, LFP_INT32 iSig);
    LFP_INT32(*pthread_attr_init)
    (LFP_PTHREAD_ATTR_T *);
    LFP_INT32(*pthread_attr_setdetachstate)
    (LFP_PTHREAD_ATTR_T *, LFP_INT32);
    LFP_INT32(*pthread_attr_getdetachstate)
    (LFP_PTHREAD_ATTR_T *, LFP_INT32 *);
    LFP_INT32(*pthread_attr_destroy)
    (LFP_PTHREAD_ATTR_T *);
} LFP_ARCH_ADAPTER_PTHREAD_T;

/* Mutex function cluster */
typedef struct lfp_arch_adapter_mutex_t {
    LFP_INT32(*mutex_init)
    (LFP_MUTEX_T *mutex, LFP_MUTEX_ATTR_T *pAttr);
    LFP_INT32(*mutex_lock)
    (LFP_MUTEX_T *mutex);
    LFP_INT32(*mutex_unlock)
    (LFP_MUTEX_T *mutex);
    LFP_INT32(*mutex_destroy)
    (LFP_MUTEX_T *mutex);
} LFP_ARCH_ADAPTER_MUTEX_T;

/* Semaphore function cluster */
typedef struct lfp_arch_adapter_semaphore_t {
    LFP_INT32(*semaphore_init)
    (LFP_SEM_T *sem, LFP_INT32 iShared, LFP_UINT32 uiInitVal);
    LFP_INT32(*semaphore_wait)
    (LFP_SEM_T *sem, LFP_INT32 iWaitTime);
    LFP_INT32(*semaphore_post)
    (LFP_SEM_T *sem);
    LFP_INT32(*semaphore_destroy)
    (LFP_SEM_T *sem);
...
typedef struct lfp_arch_adapter_fileio_t {
    LFP_INT32(*fileio_open)
    (LFP_CONST LFP_INT8 *pPath, LFP_INT32 iFlags, LFP_INT32 iMode);
    LFP_OFF_T(*fileio_seek)
    (LFP_INT32 iFd, LFP_OFF_T iOffset, LFP_INT32 iWhence);
    LFP_INT32(*fileio_fcntl)
    (LFP_INT32 iFd, LFP_INT32 iStyle);
    LFP_INT32(*fileio_read)
    (LFP_INT32 iFd, LFP_VOID *pBuf, LFP_SIZE_T bytes);
    LFP_INT32(*fileio_write)
    (LFP_INT32 iFd, LFP_CONST LFP_VOID *pBuf, LFP_SIZE_T bytes);
    LFP_INT32(*fileio_close)
    (LFP_INT32 iFd);
...
typedef struct lfp_arch_adapter_stdio_t {
    ...
    LFP_INT32(*stdio_seek)
    (LFP_FILE *pFp, LFP_LONG iOffset, LFP_INT32 iWhence);
    LFP_SIZE_T(*stdio_read)
    (LFP_VOID *LFP_RESTRICT pBuf, LFP_SIZE_T size, LFP_SIZE_T nobjs,
     LFP_FILE *LFP_RESTRICT pFp);
    LFP_SIZE_T(*stdio_write)
    (LFP_CONST LFP_VOID *LFP_RESTRICT pBuf, LFP_SIZE_T size, LFP_SIZE_T nobjs,
     LFP_FILE *LFP_RESTRICT pFp);
    LFP_INT32(*stdio_close)
    (LFP_FILE *pFp);
...
typedef struct lfp_arch_adapter_time_t {
    LFP_INT32(*sleep_ms)
    (LFP_UINT32 uiSleepMsSeconds);
    LFP_INT32(*sleep_s)
    (LFP_UINT32 uiSleepSeconds);
    LFP_TIME_T(*get_time)
    (LFP_TIME_T *ptTime);
} LFP_ARCH_ADAPTER_TIME_T;

typedef struct lfp_arch_adapter_socket_t {
    LFP_INT32(*socket_create)
    (LFP_INT32, LFP_INT32, LFP_INT32);
    LFP_INT32(*socket_bind)
    (LFP_INT32, LFP_CONST LFP_SOCK_ADDR_T *, LFP_SOCKLEN_T);
    LFP_INT32(*socket_listen)
    (LFP_INT32, LFP_INT32);
    LFP_INT32(*socket_accept)
    (LFP_INT32, LFP_SOCK_ADDR_T *, LFP_SOCKLEN_T *);
    LFP_INT32(*socket_connect)
    (LFP_INT32, LFP_CONST LFP_SOCK_ADDR_T *, LFP_SOCKLEN_T);
    LFP_INT32(*socket_close)
    (LFP_INT32);
    LFP_SSIZE_T(*socket_write)
    (LFP_INT32, LFP_CONST LFP_VOID *, LFP_SIZE_T);
    LFP_INT32(*socket_fcntl)
    (LFP_INT32, LFP_INT32);
    LFP_SSIZE_T(*socket_send)
    (LFP_INT32, LFP_CONST LFP_VOID *, LFP_SIZE_T, LFP_INT32);
    LFP_SSIZE_T(*socket_sendto)
    (LFP_INT32, LFP_CONST LFP_VOID *, LFP_SIZE_T, LFP_INT32,
     LFP_CONST LFP_SOCK_ADDR_T *, LFP_SOCKLEN_T);
    LFP_SSIZE_T(*socket_sendmsg)
    (LFP_INT32, LFP_CONST LFP_MSGHDR_T *, LFP_INT32);
    LFP_SSIZE_T(*socket_read)
    (LFP_INT32, LFP_VOID *, LFP_SIZE_T);
    LFP_SSIZE_T(*socket_recv)
    (LFP_INT32, LFP_VOID *, LFP_SIZE_T, LFP_INT32);
    LFP_SSIZE_T(*socket_recvfrom)
    (LFP_INT32, LFP_VOID *, LFP_SIZE_T, LFP_INT32, LFP_SOCK_ADDR_T *,
     LFP_SOCKLEN_T *);
    LFP_SSIZE_T(*socket_recvmsg)
