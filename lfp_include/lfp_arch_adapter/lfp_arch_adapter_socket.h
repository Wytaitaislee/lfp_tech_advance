...
/*@fn		  LFP_INT32 lfp_socket_bind(LFP_INT32 iSocketFd, LFP_CONST
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_INT32 lfp_socket_bind(LFP_INT32 iSocketFd, const LFP_SOCK_ADDR_T *pStruAddr,
                          LFP_SOCKLEN_T iSockLen);

/*@fn		  LFP_INT32 lfp_socket_listen(LFP_INT32 iSocket, LFP_INT32
 * iMaxConnect)
...
/*@fn		  LFP_INT32 lfp_socket_accept(LFP_INT32 iSocket, LFP_SOCK_ADDR_T
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_INT32 lfp_socket_accept(LFP_INT32 iSockFd, LFP_SOCK_ADDR_T *pStruAddr,
                            LFP_SOCKLEN_T *pSockLen);

/*@fn		  LFP_INT32 lfp_socket_connect(LFP_INT32 iSocket, const
 * LFP_SOCK_ADDR_T *pStruAddr, LFP_SOCKLEN_T iSockLen)
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_INT32 lfp_socket_connect(LFP_INT32 iSocketFd,
...
/*@fn		  LFP_SSIZE_T lfp_socket_write(LFP_INT32 iSocket, LFP_CONST
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_SSIZE_T lfp_socket_write(LFP_INT32 iSocketFd, LFP_CONST LFP_VOID *pBuf,
                             LFP_SIZE_T iLen);

/*@fn		  LFP_INT32 lfp_socket_fcntl(LFP_INT32 iSocket, LFP_INT32
 * iStyle)
...
/*@fn		  LFP_SSIZE_T lfp_socket_send(LFP_INT32 iSocket, LFP_CONST
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_SSIZE_T lfp_socket_send(LFP_INT32 iSocketFd, LFP_CONST LFP_VOID *pBuf,
                            LFP_SIZE_T iLen, LFP_INT32 iFlags);

/*@fn		  lfp_socket_sendto(LFP_INT32 iSocket, LFP_CONST LFP_VOID* pBuf,
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T lfp_socket_sendto(LFP_INT32 iSockFd, const LFP_VOID *pBuf,
                              LFP_SIZE_T iLen, LFP_INT32 iFlags,
                              const LFP_SOCK_ADDR_T *pDstAddr,
                              LFP_SOCKLEN_T iSockLen);

/*@fn		  LFP_SSIZE_T lfp_socket_sendmsg(LFP_INT32 iSocket, LFP_CONST
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_SSIZE_T lfp_socket_sendmsg(LFP_INT32 iSocketFd, const LFP_MSGHDR_T *pMsg,
                               LFP_INT32 iFlags);

/*@fn		  LFP_SSIZE_T lfp_socket_read(LFP_INT32 iSocket, LFP_VOID* pBuf,
 * LFP_SIZE_T iLen)
...
/*@fn		  LFP_SSIZE_T lfp_socket_recv(LFP_INT32 iSocket, LFP_VOID* pBuf,
 * LFP_SIZE_T iLen, LFP_INT32 iFlags)
 * @brief 	  recv data from a specified socket.
 * @param[in]  LFP_INT32 iSocket - The specified socket
 * @param[in]  LFP_CONST LFP_VOID* pBuf - the data to be recv
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_SSIZE_T lfp_socket_recv(LFP_INT32 iSockFd, LFP_VOID *pBuf, LFP_SIZE_T iLen,
                            LFP_INT32 iFlags);

/*@fn		  LFP_SSIZE_T lfp_socket_recvfrom(LFP_INT32 iSockFd, LFP_VOID*
...
* @return	  LFP_OK / LFP_ERR
*/
LFP_SSIZE_T lfp_socket_recvfrom(LFP_INT32 iSockFd, LFP_VOID *pBuf,
                                LFP_SIZE_T iLen, LFP_INT32 iFlags,
                                LFP_SOCK_ADDR_T *pSrcAddr,
                                LFP_SOCKLEN_T *pSockLen);

/*@fn		  LFP_SSIZE_T lfp_socket_recvmsg(LFP_INT32 iSocket, LFP_MSGHDR_T
 * *pMsg, LFP_INT32 iFlags)
 ...
 * @return	  LFP_OK / LFP_ERR
 */
LFP_SSIZE_T lfp_socket_recvmsg(LFP_INT32 iSocketFd, LFP_MSGHDR_T *pMsg,
                               LFP_INT32 iFlags);
