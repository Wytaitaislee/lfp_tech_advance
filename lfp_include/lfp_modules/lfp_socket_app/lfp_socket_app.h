...
#define LFP_SOCKET_SERVER_CRIT(...)   \
	LFP_UTIL_BASE(UTIL_LEVEL_CRIT, UTIL_MODULE_SOCKET, MASK_SOCKET_SERVER, __VA_ARGS__) 
#define LFP_SOCKET_SERVER_ERR(...)   \
	LFP_UTIL_BASE(UTIL_LEVEL_ERR, UTIL_MODULE_SOCKET, MASK_SOCKET_SERVER, __VA_ARGS__) 
#define LFP_SOCKET_SERVER_INFO(...)   \
	LFP_UTIL_BASE(UTIL_LEVEL_INFO, UTIL_MODULE_SOCKET, MASK_SOCKET_SERVER, __VA_ARGS__)

#define LFP_SOCKET_CLIENT_CRIT(...)   \
	LFP_UTIL_BASE(UTIL_LEVEL_CRIT, UTIL_MODULE_SOCKET, MASK_SOCKET_CLIENT, __VA_ARGS__)
#define LFP_SOCKET_CLIENT_ERR(...)   \
	LFP_UTIL_BASE(UTIL_LEVEL_ERR, UTIL_MODULE_SOCKET, MASK_SOCKET_CLIENT, __VA_ARGS__)
#define LFP_SOCKET_CLIENT_INFO(...)   \
	LFP_UTIL_BASE(UTIL_LEVEL_INFO, UTIL_MODULE_SOCKET, MASK_SOCKET_CLIENT, __VA_ARGS__) 


#define LFP_SOCKET_CTRL_CRIT(...)   \
	LFP_UTIL_BASE(UTIL_LEVEL_CRIT, UTIL_MODULE_SOCKET, MASK_SOCKET_CTRL, __VA_ARGS__)
#define LFP_SOCKET_CTRL_ERR(...)   \
	LFP_UTIL_BASE(UTIL_LEVEL_ERR, UTIL_MODULE_SOCKET, MASK_SOCKET_CTRL, __VA_ARGS__)
#define LFP_SOCKET_CTRL_INFO(...)   \
	LFP_UTIL_BASE(UTIL_LEVEL_INFO, UTIL_MODULE_SOCKET, MASK_SOCKET_CTRL, __VA_ARGS__) 
...
#define LFP_SOCKET_THIS_RECV_HEAD(pDesc) ((LFP_SOCKET_THIS_RECV(pDesc)).struHead)
#define LFP_SOCKET_THIS_RECV_BODY(pDesc) (LFP_SOCKET_THIS_RECV(pDesc).iPackageData)
#define LFP_SOCKET_THIS_SEND_HEAD(pDesc) (LFP_SOCKET_THIS_SEND(pDesc).struHead)
#define LFP_SOCKET_THIS_SEND_BODY(pDesc) (LFP_SOCKET_THIS_SEND(pDesc).iPackageData)
#define LFP_SOCKET_THIS_BODY_OFFSET(pDesc)	(sizeof(pDesc->struSocketCtrl.struSendCtrl.struHead))
...
/*@fn		  LFP_INT32 LFP_INT32 lfp_socket_send_data(LFP_INT32 iSocket, LFP_CONST LFP_INT8* pData, LFP_INT32 iDataLen)
