/*
 * @FilePath: lfp_socket_client.c
 * @Description: Socket communication client implementation.
 * @Author: wytaitaislee
 * @Date: 2021-08-27 23:29:52
 * @LastEditTime: 2022-03-08 22:49:34
...
LFP_INT32 lfp_socket_client_task(LFP_VOID* pClientArgs) {
  ...
  if (LFP_OK != lfp_socket_connect(iSockClient,
                                   (LFP_SOCK_ADDR_T*)&struSockAddrIn,
                                   sizeof(LFP_SOCK_ADDR_T))) {
  ...
  ,strerror(errno)); iRet = LFP_ERR; goto my_return;
  }
  */
