...
#define LFP_APP_BUSYBOX_REGISTER(name, help, auth, proc) \
...
/*@fn		  LFP_STATIC LFP_INT32 lfp_app_busybox_gettime(LFP_INT8 iArgs,
 ...
 * @return	  LFP_OK
 */
LFP_STATIC LFP_INT32 lfp_app_busybox_gettime(LFP_INT8 iArgs,
                                             LFP_CONST LFP_INT8 **ppArgv) {
  (LFP_VOID) iArgs;
  (LFP_VOID) ppArgv;
  return LFP_OK;
